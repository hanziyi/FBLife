...
import com.group.yztcedu.fblife.main.carbarn.CarbarnFragment;
...
public class MainActivity extends BaseActivity implements MainContract.View {
    ...
    private CarbarnFragment carbarnFragment;
    ...
    private void selectFragment(int position) {
      ...
      transaction.hide(homeFragment).hide(forumFragment).hide(carbarnFragment).hide(videoFragment).hide(storeFragment);
        switch (position) {
            case SELECTED_HOME:
            ...
            case SELECTED_CARBARN:
                transaction.show(carbarnFragment);
                break;
            case SELECTED_VIDEO:
